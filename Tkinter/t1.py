...
def button_click(number):
    current = e.get()
    e.insert(0,str(current) + str(current))
    print(current)
...
button_ad = Button(root, text="+", padx=40, pady=20,bg="black", fg="white", command=lambda: button_click('+'))
button_equal = Button(root, text="=", padx=85, pady=20,bg="black", fg="white", command=lambda: button_click)
button_clear = Button(root, text="clear", padx=77, pady=20,bg="black", fg="white", command=lambda: button_click)
